...
mkdir -p $GENOMEDIR/STAR1
STAR --runThreadN 8 --runMode genomeGenerate --genomeDir $GENOMEDIR/STAR1 --genomeFastaFiles $GENOMEDIR/Assembly.fasta --sjdbGTFfile $GENOMEDIR/Assembly.gff --sjdbGTFtagExonParentTranscript Parent
