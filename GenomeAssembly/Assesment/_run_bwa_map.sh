...
inputDir="/home/sra_data/fastq/Paired"
outputDir="/home/sra_data/bwa_paired"

for f in *fastq
do 
prefix=`basename $f | cut --bytes=1-11`
bwa mem -M -t 8 $GENOMEDIR/ND_Assembly_Final_idx $inputDir/${prefix}_1.fastq $inputDir/${prefix}_2.fastq > $outputDir/${prefix}.sam
done
