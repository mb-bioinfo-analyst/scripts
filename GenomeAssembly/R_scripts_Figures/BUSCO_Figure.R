...
# Output
# Modify the directory to where all the busco reports are located
my_output <- paste("../buscoReports/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('AgambiaePEST', 'AgambiaePEST', 'AgambiaePEST', 'AgambiaePEST', 'AS_flye_NP_ragoo', 'AS_flye_NP_ragoo', 'AS_flye_NP_ragoo', 'AS_flye_NP_ragoo', 'AS_ND_NP_ragoo', 'AS_ND_NP_ragoo', 'AS_ND_NP_ragoo', 'AS_ND_NP_ragoo', 'AS_Ra_NP_ragoo', 'AS_Ra_NP_ragoo', 'AS_Ra_NP_ragoo', 'AS_Ra_NP_ragoo', 'GCA_000441895', 'GCA_000441895', 'GCA_000441895', 'GCA_000441895', 'GCA_000472065', 'GCA_000472065', 'GCA_000472065', 'GCA_000472065', 'GCA_015501955', 'GCA_015501955', 'GCA_015501955', 'GCA_015501955')
...
my_percentage <- c(96.6, 1.6, 0.3, 1.5, 97.4, 0.8, 0.4, 1.4, 97.6, 0.6, 0.4, 1.4, 97.4, 0.8, 0.4, 1.4, 96.2, 0.5, 1.1, 2.2, 91.0, 0.9, 3.7, 4.4, 98.4, 0.4, 0.4, 0.8)
my_values <- c(3174, 54, 11, 46, 3199, 26, 14, 46, 3205, 20, 12, 48, 3200, 25, 12, 48, 3159, 18, 36, 72, 2988, 28, 122, 147, 3231, 13, 13, 28)
